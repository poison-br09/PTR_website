...
export const REGISTRATIONS: Record<string, RegistrationData> = {
    ...
    'digital-signature-certificate': { slug: 'digital-signature-certificate', title: 'Digital Signature Certificate (DSC) Online in India', subtitle: 'Get your Digital Signature Certificate for MCA filings, GST, Income Tax e-filing, and other online transactions.', heroFeatures: ['DSC in 1–2 Business Days', 'Class 3 DSC for MCA Filing', '2-Year Validity', 'USB Token Included', 'Recognized Certifying Authorities'], overview: { heading: 'What is a Digital Signature Certificate?', paragraphs: ['A Digital Signature Certificate (DSC) is an electronic form of a signature used to authenticate the identity of the sender of an electronic document. It is the digital equivalent of a physical signature.', 'DSC is mandatory for filing documents on the MCA portal, GST portal, Income Tax e-filing, e-tendering, and other government platforms.', 'In India, DSCs are issued by Certifying Authorities (CAs) licensed by the Controller of Certifying Authorities (CCA) under the Information Technology Act, 2000.'], highlights: [{ icon: '🔒', text: 'Secure electronic signature' }, { icon: '📋', text: 'Mandatory for MCA, GST, and IT filings' }, { icon: '📅', text: '1–2 year validity' }, { icon: '⚖️', text: 'Legally valid under IT Act, 2000' }, { icon: '💻', text: 'Stored on USB token' }] }, eligibility: ['Any individual, director, or authorized signatory.', 'Valid PAN and Aadhaar required.', 'Must complete Aadhaar-based or video-based verification.'], documents: [{ category: 'Required Documents', items: ['PAN Card', 'Aadhaar Card', 'Passport-sized photograph', 'Email ID & mobile number (linked with Aadhaar)', 'Video verification or Aadhaar OTP'] }], process: [{ title: 'Choose DSC Class & Validity', desc: 'Select Class 3 DSC (required for MCA filing) with 1 or 2-year validity.', time: '' }, { title: 'Submit Application', desc: 'Fill the application form with personal details.', time: '' }, { title: 'Complete Verification', desc: 'Verify identity via Aadhaar OTP or video verification.', time: '' }, { title: 'Receive DSC on USB Token', desc: 'DSC is issued and loaded on a USB token for use.', time: '1–2 days' }], fees: [{ item: 'Class 3 DSC (2 years)', cost: '₹1,500 – ₹2,500' }, { item: 'USB Token', cost: 'Usually included' }, { item: 'Professional Charges', cost: '₹500 onwards' }], advantages: [{ icon: '🔒', title: 'Security', desc: 'Tamper-proof authentication of electronic documents.' }, { icon: '⚖️', title: 'Legal Validity', desc: 'Legally recognized under the IT Act, 2000.' }, { icon: '⚡', title: 'Convenience', desc: 'Sign documents electronically from anywhere.' }, { icon: '📋', title: 'Compliance', desc: 'Mandatory for MCA, GST, ITR, and e-tendering filings.' }], faqs: [{ q: 'Which class of DSC do I need?', a: 'Class 3 DSC is required for MCA filing, company incorporation, and government tenders.' }, { q: 'What is the validity?', a: 'Typically 1 or 2 years. Must be renewed before expiry.' }, { q: 'Can I use one DSC for multiple platforms?', a: 'Yes. The same DSC can be used for MCA, GST, IT filing, and other platforms.' }] },
